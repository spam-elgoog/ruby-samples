# Advent of Code[About][Events][Shop][Log In]sub y{2016}[Calendar][AoC++][Sponsors][Leaderboard][Stats]
...
# only walk on the street grid of the city, how far is the shortest path to the destination?
...
# (Twitter users: if you have auth problems that claim 
# "There is no request token for this page", please clear your twitter.com cookies and try again.)